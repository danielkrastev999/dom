...
//Función para el inline handler !! NO RECOMENDABLE
...
function showMousePosition(e) {
    let x = document.getElementById("X"); //coge los elementos X e Y
