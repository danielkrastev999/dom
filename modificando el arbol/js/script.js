...
document.getElementById("appendNode").addEventListener('click', e => {
    //Creo el nodo que voy a añadir como ultimo hijo
    let element = document.createElement("li");
    let text = document.createTextNode("SECCIÓN D"); // Le doy contenido
    
    //Construyo el nuevo nodo
    element.append(text); 

    //Lo añado al final de la lista
    document.querySelector("ul").append(element); // añado el texto como ultimo hijo
...
document.getElementById("prependNode").addEventListener('click', e => {
    ...
    //Creo el nodo que voy a añadir como primer hijo
    let element = document.createElement("li");
    let text = document.createTextNode("SECCIÓN PRE-A");

    //Construyo el nuevo nodo
    element.append(text); // añado nodo texto a la etiqueta
...
document.getElementById("beforeNode").addEventListener('click', e => {
    ...
    //Añado dicho nodo justo antes del ul
...
document.getElementById("afterNode").addEventListener('click', e => {
    ...
    //Añado dicho nodo justo despues del ul
...
document.getElementById("cloneNode").addEventListener('click', e => {
    ...
    //Clono la última fila de la tabla con todos sus hijos
